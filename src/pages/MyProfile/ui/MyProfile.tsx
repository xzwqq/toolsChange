		...
		<>
			...
			<div className='root__my'>
				...
				<div className='myProfile'>
					...
					<button onClick={ () => history.push(`/rating/${container?.owner.id}`)} className='myProfile_button'>Отзывы</button>
					<button className='myProfile_button'>Обьявления</button>
					<button className='myProfile_button red' onClick={() => removetoken()}>Выйти из аккаунта</button>
				</div>
			</div>
		</>
	);
